...
- [midzer/go-cli-template](https://github.com/midzer/go-cli-template) ([v0.0.1](https://github.com/midzer/go-cli-template/releases/tag/v0.0.1), 7 months ago) - Minimal Go CLI boilerplate/template with zero dependencies
