...
- [lokal-ninja/district-of-columbia](https://github.com/lokal-ninja/district-of-columbia) -  (1 month ago)
- [lokal-ninja/pakistan](https://github.com/lokal-ninja/pakistan) -  (1 month ago)
...
- [midzer/tobii](https://github.com/midzer/tobii) ([v2.8.1](https://github.com/midzer/tobii/releases/tag/v2.8.1), 1 week ago) - An accessible, open-source lightbox with no dependencies
...
- [optimize main loop](https://github.com/JoseTomasTocino/freegemas/pull/45) on [JoseTomasTocino/freegemas](https://github.com/JoseTomasTocino/freegemas) (3 weeks ago)
...
- [snesrev/smw](https://github.com/snesrev/smw) - Smw (2 days ago)
- [protoman/rockbot](https://github.com/protoman/rockbot) - An open-source, SDL based, game engine to replicate old style NES games, mostly Megaman ones, and an editor made with Qt, for custom graphics, weapons, bosses, enemies and level creation. (3 weeks ago)
- [Oliveshark/breakhack](https://github.com/Oliveshark/breakhack) - A casual coffee-break roguelike (4 weeks ago)
- [admin-shell-io/aas-specs-api](https://github.com/admin-shell-io/aas-specs-api) - Repository of the Asset Administration Shell Specification DTA-01002 API (4 weeks ago)
