...
- [twbs/bootstrap](https://github.com/twbs/bootstrap) ([v5.1.1](https://github.com/twbs/bootstrap/releases/tag/v5.1.1), 1 week ago) - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
- [midzer/tobii](https://github.com/midzer/tobii) ([v2.3.0](https://github.com/midzer/tobii/releases/tag/v2.3.0), 2 weeks ago) - An accessible, open-source lightbox with no dependencies
