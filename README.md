...
- [Alex313031/Thorium](https://github.com/Alex313031/Thorium) ([M104.0.5073.0](https://github.com/Alex313031/Thorium/releases/tag/M104.0.5073.0), today) - Chromium fork for Linux named after radioactive element No. 90. Windows and Special builds are in different repositories, links are towards the top of the README.md.
- [twbs/bootstrap](https://github.com/twbs/bootstrap) ([v5.2.0-beta1](https://github.com/twbs/bootstrap/releases/tag/v5.2.0-beta1), 1 week ago) - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
- [Alex313031/Thorium-Special](https://github.com/Alex313031/Thorium-Special) ([M103.0.5045.0](https://github.com/Alex313031/Thorium-Special/releases/tag/M103.0.5045.0), 2 weeks ago) - Builds of Thorium for MacOS, different processors and NEW Raspberry Pi ARM64 builds.
