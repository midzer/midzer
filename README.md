...
- [lokal-ninja/rheinland-pfalz](https://github.com/lokal-ninja/rheinland-pfalz) -  (today)
...
- [midzer/tobii](https://github.com/midzer/tobii) ([v3.1.2](https://github.com/midzer/tobii/releases/tag/v3.1.2), 6 days ago) - An accessible, open-source lightbox with no dependencies
- [Choices-js/Choices](https://github.com/Choices-js/Choices) ([v11.2.0](https://github.com/Choices-js/Choices/releases/tag/v11.2.0), 4 weeks ago) - A vanilla JS customisable select box/text input plugin ⚡️
...
- [add KMP search algorithm (gated by build flag)](https://github.com/Choices-js/Choices/pull/1277) on [Choices-js/Choices](https://github.com/Choices-js/Choices) (11 months ago)

#### 📜 My recent blog posts

- [https://midzer.de/winter-mood](https://midzer.de/winter-mood) (1 month ago)
- [https://midzer.de/a-retrospective-about-blogging-for-a-decade](https://midzer.de/a-retrospective-about-blogging-for-a-decade) (5 months ago)
...
- [rofl0r/gnuboy](https://github.com/rofl0r/gnuboy) - latest version of original laguna source, with a handful fixes for modern compilers and systems (4 weeks ago)
