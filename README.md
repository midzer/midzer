...
- [fedify-dev/hollo](https://github.com/fedify-dev/hollo) - Federated single-user microblogging software (today)
- [ArnaudBannier/space-pixels-sdl3](https://github.com/ArnaudBannier/space-pixels-sdl3) - Space Pixels is a shoot them up game developed in C (2 days ago)
