...
- [midzer/tobii](https://github.com/midzer/tobii) ([v2.8.3](https://github.com/midzer/tobii/releases/tag/v2.8.3), 2 days ago) - An accessible, open-source lightbox with no dependencies
...
- [snesrev/smw](https://github.com/snesrev/smw) - Smw (6 days ago)
- [protoman/rockbot](https://github.com/protoman/rockbot) - An open-source, SDL based, game engine to replicate old style NES games, mostly Megaman ones, and an editor made with Qt, for custom graphics, weapons, bosses, enemies and level creation. (4 weeks ago)
