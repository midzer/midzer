...
- [midzer/choices](https://github.com/midzer/choices) ([v1.0.4](https://github.com/midzer/choices/releases/tag/v1.0.4), 8 months ago) - A fast, vanilla JS customisable select box/text input plugin for modern browsers ⚡
